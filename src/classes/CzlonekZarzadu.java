...
public class CzlonekZarzadu extends Boss{
    ...
    public CzlonekZarzadu(String pozycja,String nazwa, int liczbaPracownikow,String imie, String nazwisko, double staz, int wiek, PlecEnum getPlec){
